...
enum ClientStrings {
    ...
    static let chineseSimplified: [String: String] = [
        ...
        "client.connection.saveAndReconnect": "保存并重新连接",
        "client.connection.saved": "已保存",
        "client.connection.backendServer": "后端服务器",
        "client.folder.namePlaceholder": "技术",
        "client.folder.nameLabel": "名称",
        ...
        "client.freshrss.pendingChanges": "待同步的更改",
        "client.refresh.outstanding": "剩余 {count} 项",
        "client.rule.summary": "{conditions} 个条件 · {actions} 个动作",
        "client.rule.enabled": "启用",
        ...
        "client.help.sortAndLayout": "排序方式与列表版式",
        "client.help.languageTools": "翻译与摘要",
        "client.help.moreActions": "重新载入、图片、导出与查找",
        "client.help.viewMode": "显示渲染正文或原始网页",
