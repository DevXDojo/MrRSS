...
export function generateInitialSettings(): SettingsData {
  return {
    ...
    notification_config: settingsDefaults.notification_config,
...
export function parseSettingsData(data: Record<string, string>): SettingsData {
  return {
    ...
    notification_config: data.notification_config || settingsDefaults.notification_config,
...
export function buildAutoSavePayload(settingsRef: Ref<SettingsData>): Record<string, string> {
  return {
    ...
    notification_config: settingsRef.value.notification_config ?? settingsDefaults.notification_config,
