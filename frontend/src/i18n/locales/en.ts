...
const en: TranslationMessages = {
  ...
  modal: {
    ...
    rule: {
      ...
      addCondition: 'Add Condition',
      exportRules: 'Export rules', importRules: 'Import rules',
      importConfirm: 'Append {count} rules to the existing list? Their enabled states will be preserved. They will apply to future refreshes; existing articles will not be processed now.',
      importSuccess: 'Imported {count} rules', invalidBackup: 'Invalid or unsupported MrRSS rules backup. No rules were imported.',
      backupTooLarge: 'The rules backup exceeds the 5 MB limit.', importFailed: 'Could not import rules. Please reload settings before retrying.',
      addRule: 'Add Rule',
      condition: 'Condition',
