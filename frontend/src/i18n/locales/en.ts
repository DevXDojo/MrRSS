  ...
  modal: {
    ...
    feed: {
      ...
      picker: {
        ...
        hint: 'Click an article container, move to its parent if needed, then choose it. Select fields within that article and check the matching samples before applying.',
        staticHint: 'Safe static preview: original styles, scripts and external resources are omitted. JavaScript-only lists need a custom script. Set the date format in the feed form after applying.',
        item: 'Article container', titleField: 'Title',
        uri: 'Link', timestamp: 'Date', content: 'Summary', thumbnail: 'Thumbnail',
        selectElement: 'Click an element in the preview.', parent: 'Parent element', choose: 'Choose element',
        withinItem: 'Select fields inside the chosen article. For links select the link text; for thumbnails select an image placeholder.',
        matches: '{count} matching containers', apply: 'Apply XPath', retry: 'Retry preview',
        loadFailed: 'Could not load this page. Check its URL, proxy and connectivity, or use a custom script.',
      },
